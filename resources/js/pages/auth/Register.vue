    ...
    >
        ...
        >
            ...
            <div class="relative my-2 text-center">
                <span class="px-2 text-xs uppercase tracking-wider text-zinc-500">nebo se zaregistrujte přes</span>
            </div>

            <div class="flex items-center justify-center gap-3" aria-label="Sociální registrace">
                <a href="/auth/github/redirect" class="inline-flex size-10 items-center justify-center rounded-md border bg-white text-zinc-700 hover:bg-zinc-50 dark:border-zinc-800 dark:bg-transparent dark:text-zinc-200 dark:hover:bg-zinc-900" tabindex="6" aria-label="Continue with GitHub">
                ...
                <a href="/auth/google/redirect" class="inline-flex size-10 items-center justify-center rounded-md border bg-white text-zinc-700 hover:bg-zinc-50 dark:border-zinc-800 dark:bg-transparent dark:text-zinc-200 dark:hover:bg-zinc-900" tabindex="7" aria-label="Continue with Google">
